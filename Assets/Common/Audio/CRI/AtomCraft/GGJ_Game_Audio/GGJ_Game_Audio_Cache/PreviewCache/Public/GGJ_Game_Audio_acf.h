...
#define CRI_GGJ_GAME_AUDIO_ACF_CATEGORY_MUSIC                ( 2) /*  */
#define CRI_GGJ_GAME_AUDIO_ACF_CATEGORY_PLAYER_SOUNDS        ( 1) /*  */
#define CRI_GGJ_GAME_AUDIO_ACF_CATEGORY_DUCKED               ( 4) /*  */
#define CRI_GGJ_GAME_AUDIO_ACF_CATEGORY_ENNEMY_ALERT         ( 3) /*  */
